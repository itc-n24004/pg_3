...
response.close()
#print(soup)    #青空文庫のペーtags_to_deleteジ内容そのもの

title_text = soup.find('h1', class_='title') #タイトルを摘出
author_text = soup.find('h2', class_='author') #作者名を摘出
#作品の本文のみを抽出
